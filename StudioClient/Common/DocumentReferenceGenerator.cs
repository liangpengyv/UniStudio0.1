...
namespace StudioClient.Common {
	...
	public static class DocumentReferenceGenerator {
		...
		private static void AddDocumentReference(RecentDocumentManager manager, Uri uri, bool isPinned) {
			...
			docRef.ImageSourceSmall = new BitmapImage(new Uri("/Resources/Images/RichTextDocument16.png", UriKind.Relative));
			docRef.ImageSourceLarge = new BitmapImage(new Uri("/Resources/Images/RichTextDocument32.png", UriKind.Relative));
